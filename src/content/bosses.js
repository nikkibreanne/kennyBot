 ...
 * id format: s<season>w<week>.  Reference win-rate ramp per week (measured at
 * REF=15 over 200 seeds, recalibrated 2026-06 for the affix-aware engine —
 * interleaved initiative, critter adds, party DoT, reduced healing, recoil,
 * frost and boss cleave):
 *   S1: ~100 96 91 80 65 50   S2: ~100 96 88 78 62 44   S3: ~100 94 87 74 54 40
 * (finale = hardest; harder across seasons). NOTE: post-mechanics, `baseHp` —
 * like `atk` (see the per-field note above) — is calibrated PER BOSS against its
 * affix+abilitySet, so neither is strictly monotonic week-to-week: a high-
 * lethality single-target boss (bruiser/breaker) reaches its target win-rate at
 * a LOWER HP and HIGHER atk than an attrition AoE boss (caster/swarmer/finale).
 * Difficulty is carried by the WIN-RATE ramp and the muster thresholds (both
 * monotonic), not by raw baseHp/atk. Re-tune with scratchpad/rebalance/.
 * @type {Boss[][]}
 */
export const SEASONS = [
  ...
  [
    {
      id: 's1w1', name: 'Lady Aphidia, the Aphid Empress', baseHp: 9500, atk: 80,
    ...
    {
      id: 's1w2', name: 'The Slugfather', baseHp: 8100, atk: 243,
    ...
    {
      id: 's1w3', name: 'Bindweed Behemoth', baseHp: 11900, atk: 164,
    ...
    {
      id: 's1w4', name: 'Sir Nibblesworth, Tyrant of the Carrot Tops', baseHp: 11000, atk: 183,
    ...
    {
      id: 's1w5', name: 'The Powdery Mildew Wraith', baseHp: 15300, atk: 85,
    ...
    {
      id: 's1w6', name: 'Jack o\' the Rotten Row, the Scarecrow King', baseHp: 13900, atk: 94,
  ...
  [
    {
      id: 's2w1', name: 'Thornwretch the Bramblebound', baseHp: 14800, atk: 130,
    ...
    {
      id: 's2w2', name: 'Old Man Sunscorch', baseHp: 13900, atk: 258,
    ...
    {
      id: 's2w3', name: 'The Ten-Lined Horde', baseHp: 14800, atk: 124,
    ...
    {
      id: 's2w4', name: 'Madame Venus & the Snaptrap Coven', baseHp: 14600, atk: 223,
    ...
    {
      id: 's2w5', name: 'The Hornworm Broodmother', baseHp: 19600, atk: 104,
    ...
    {
      id: 's2w6', name: 'The Cornstalk Colossus, Tyrant of Tassels', baseHp: 18300, atk: 118,
  ...
  [
    {
      id: 's3w1', name: 'The Mulchgeist', baseHp: 16400, atk: 130,
    ...
    {
      id: 's3w2', name: 'Gourdfather the Hollow', baseHp: 17600, atk: 301,
    ...
    {
      id: 's3w3', name: 'The Tatterking', baseHp: 19600, atk: 139,
    ...
    {
      id: 's3w4', name: 'Hoarfrost the Untimely', baseHp: 16400, atk: 262,
    ...
    {
      id: 's3w5', name: 'Root of All Rot, the Wormwood Choir', baseHp: 24600, atk: 124,
    ...
    {
      id: 's3w6', name: 'Her Verdant Majesty, the Okra Eternal', baseHp: 24500, atk: 131,
